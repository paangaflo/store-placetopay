...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        Product::create([
                ...
                'price' => 12315690.99,
                'image' => "storage/images/products/monitor-se2219h.jpg",
                'stock' => 12,
                'categories_id' => 1
        ]);
        Product::create([
                ...
                'price' => 1120000.99,
                'image' => "storage/images/products/monitor-s2419h.jpeg",
                'stock' => 10,
                'categories_id' => 1
        ]);
        Product::create([
                ...
                'price' => 3240000.00,
                'image' => "storage/images/products/monitor-s2419hgf.jpeg",
                'stock' => 5,
                'categories_id' => 1
        ]);
        Product::create([
                ...
                'price' => 180000.99,
                'image' => "storage/images/products/mochila-es1520p.jpg",
                'stock' => 11,
                'categories_id' => 2
        ]);
        Product::create([
                ...
                'price' => 140500.80,
                'image' => "storage/images/products/mochila-pe1420v.jpg",
                'stock' => 3,
                'categories_id' => 2
        ]);
        Product::create([
                ...
                'price' => 249999.00,
                'image' => "storage/images/products/mochila-460-bcjy.jpg",
                'stock' => 8,
                'categories_id' => 2
        ]);
    }
